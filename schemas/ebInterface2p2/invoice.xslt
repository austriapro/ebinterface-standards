...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:eb="http://www.ebinterface.at/schema/2p2/" xmlns:dsig="http://www.w3.org/2000/09/xmldsig#">
...
hr{
    ...
    <xsl:template match="//eb:Biller" mode="details">
        ...
        <tr>
            ...
            <td colspan="2">
				...
				<xsl:if test="eb:DPRNumber">
					<xsl:apply-templates select="eb:DPRNumber"/><br/>
                </xsl:if>
    ...
    <!-- ===================== DPR ======================= -->
    <xsl:template match="//eb:DPRNumber">
        DVR: <xsl:value-of select="."/>
    </xsl:template>
    <!-- ==================== Address ==================== -->
    ...
    <xsl:template match="//eb:ItemList">
		...
		<xsl:if test="//eb:VAT/eb:TaxExemption">
			<tr>
				<xsl:element name="td">
					...
					Diese Rechnung unterliegt nicht der Umsatzsteuer!
				</xsl:element>
			</tr>
		</xsl:if>
        <xsl:if test="//eb:VAT/eb:Item">
		...
		<xsl:if test="//eb:Tax/eb:OtherTax">
    ...
    <xsl:template match="//eb:Delivery">
        ...
        <tr><td colspan="3"><hr/><br/></td></tr>
        <xsl:for-each select="eb:Date | eb:Period">
            <xsl:choose>
                <xsl:when test="name(.)='eb:Date'">
                    <tr>
                        <td>&#160;</td>
                        <td>
