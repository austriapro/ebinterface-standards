...
import at.ebinterface.validation.test.digitalsignatures.SubmittedFilesTest;
...
public enum MOASignatureValidator {
	 ...
	 */
	public VerifyXMLSignatureResponse validate(byte[] signed, String signatureNameSpacePrefix) throws Exception
	{
		ByteArrayInputStream bIn = new ByteArrayInputStream(signed);
	 ...
	 * @throws
	 */
	public VerifyXMLSignatureResponse validate(InputStream signed, String signatureNamespacePrefix) throws Exception {

		Content sigDocContent = spssFac.createContent(signed, null);
		...
		StringBuffer signatureElementReference = new StringBuffer();
		...
		VerifySignatureLocation sigLocation = spssFac.createVerifySignatureLocation(signatureElementReference.toString(), nSMap);
		...
		// Create request
		VerifyXMLSignatureRequest verifyRequest = spssFac.createVerifyXMLSignatureRequest(null, // null
																								// =
																								// current
																								// time
				sigInfo, 
