...
import at.ebinterface.validation.web.utils.Utils;
...
public class ResultPage extends BasePage {
	 ...
	 * @param schemaValidationErrorMessages
	 */
	public ResultPage(ValidationResult validationResult, String selectedSchematron, ActionType selectedAction) {
		
		StringBuffer schemaVersion = new StringBuffer();
		schemaVersion.append(Utils.INSTANCE.getPrettyPrintedEbInterfaceVersion(validationResult.getDeterminedEbInterfaceVersion()));
		...
		//Schema OK Container
		WebMarkupContainer schemaOkContainer = new WebMarkupContainer("schemvalidationOK");				
		add(schemaOkContainer);
				
		//Schema NOK Container
		WebMarkupContainer schemaNOkContainer = new WebMarkupContainer("schemvalidationNOK");
		...
		WebMarkupContainer schematronOkContainer = new WebMarkupContainer("schematronOK");
		...
		WebMarkupContainer schematronNokContainer = new WebMarkupContainer("schematronNOK");
		
		schematronNokContainer.add(new Label("selectedSchematron", Model.of(selectedSchematron)));
		
		Result schematronResult = validationResult.getResult();
	 ...
	 * @return
	 */
	private IModel<String> getBooleanAsString(Boolean b) {
		if (b == null) {
			return Model.of("-");
		}
